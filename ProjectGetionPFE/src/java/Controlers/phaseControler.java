...
/**
 * Servlet implementation class phaseControler
 */
public class phaseControler extends HttpServlet {
	...
	private void addPhase(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException {
		
		
		 int id  =  Integer.parseInt(request.getParameter("idphas"));
	  ...
	  Phase pas = new Phase(id, nom, drst, dtfin);
		
		phaseDAO.add(pas, idproj);
		 
		
		 
		 
		if(phaseDAO.add(pas, idproj))
					listProject(request, response);
	            else
	...
	private void listProject(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// get students from db util
				...
				// add students to the request
					...
					RequestDispatcher dispatcher = request.getRequestDispatcher("tables-phase.jsp");
