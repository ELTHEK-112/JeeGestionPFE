					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    ...
                                    <ol class="breadcrumb float-right">
										...
										<li class="breadcrumb-item active">Form Etudiant</li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-hand-pointer-o"></i> Form Etudiant</h3>
								
							</div>
								
							<div class="card-body">
																
										<form action="controlerEtudint" method="get" data-parsley-validate novalidate>
										            <input type="hidden" value="2" name="command">
                                                    <div class="form-group">
                                                        <label for="userName">Nom :<span class="text-danger">*</span></label>
                                                        <input type="text" name="nom" data-parsley-trigger="change" required placeholder="Enter Nom" class="form-control" id="userName">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="userName">Prenom :<span class="text-danger">*</span></label>
                                                        <input type="text" name="prenom" data-parsley-trigger="change" required placeholder="Enter Prenom" class="form-control" id="userName">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="userName">CNE :<span class="text-danger">*</span></label>
                                                        <input type="text" name="cin" data-parsley-trigger="change" required placeholder="Enter CNE" class="form-control" id="userName">
                                                    </div>
                                                     <div class="form-group">
                                                        <label for="userName">Branch :<span class="text-danger">*</span></label>
                                                        <input type="text" name="brnch" data-parsley-trigger="change" required placeholder="Enter branch" class="form-control" id="userName">
                                                    </div>
                                                    	<%
                       try{
                    	   ResultSet re = SingleConnection.readQury("select MAX(ID) from etudiant");
                             while(re.next()){
                      ...
                      %>
                                                    <div class="form-group">
                                                        <label for="pass1">ID Etudinat :<span class="text-danger">*</span></label>
                                                        <input id="id" name="id"  value="<%=id %>" readonly type="text" placeholder="ID" required class="form-control">
                                                    <% 
                             }
