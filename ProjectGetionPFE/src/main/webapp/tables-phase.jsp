...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="indexEtudinat.jsp" class="logo"><img alt="Logo" src="assets/images/logo.png" /> <span>Admin</span></a>
        </div>
</div>
					...
					<li class="submenu">
                        <a href="#" class="active"><i class="fa fa-fw fa-table"></i> <span> Tables </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
								...
								<li class="active"><a href="tables-task.jsp">Les Tash</a></li>
        ...
        <div class="content">
			...
			<div class="container-fluid">
						...
						<div class="col-xl-12">
								<div class="breadcrumb-holder">
										...
										<ol class="breadcrumb float-right">
											...
											<li class="breadcrumb-item active">Les Phase</li>
										</ol>
										<div class="clearfix"></div>
								</div>
						</div>
				...
				<div class="row">
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<tbody>
										<%
										       ArrayList<Phase> list = phaseDAO.getAll();
										
										    for(int i = 0 ; i<list.size();i++){
										    	
										    	
										    if(list.get(i).getProjetFE().getIdProjetFE() == etd.getProjetFE().getIdProjetFE()){
										    	

										%>
											<tr>
											   <td><%=list.get(i).getIdPhase() %></td>
												<td><%=list.get(i).getNom() %></td>
												<td><%=list.get(i).getProjetFE().getNom()%></td>
												<td><%=list.get(i).getDateStar() %></td>
												<td><%=list.get(i).getDateFin() %></td>
												<td>
												<a href="#addtask<%=list.get(i).getIdPhase() %>" data-toggle="modal" >
                            <button type='button' class="btn btn-success"><i class="fa fa-check"></i></button>
                                                    </a>
                                                     <a href="#edit<%=list.get(i).getIdPhase() %>" data-toggle="modal" >
                            <button type='button'  class="btn btn-info"><i class="fa fa-exclamation"></i></button>
                            </a>
                            <a href="#delete<%=list.get(i).getIdPhase() %>" data-toggle="modal">
                            <button type='button' class="btn btn-danger"><i class="fa fa-times"></i></button>
                            </a>
                             <div id="edit<%=list.get(i).getIdPhase() %>" class="modal fade" role="dialog">
                          <form method="get" action="taskControlr" class="form-horizontal" role="form">
                              <input type="hidden" name="idphas" value="<%=list.get(i).getIdPhase() %>">
                              <input type="hidden" name="command" value="2"> 
                            <div class="modal-dialog modal-lg">
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Modifer   <%=list.get(i).getNom() %> :</h4>
                                    ...
                                    <div class="modal-body"> 
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" readonly id="item_name" value="<%=list.get(i).getIdPhase() %>" name="idtsk"  placeholder="Item Name" required autofocus>
                    ...
                    <div id="delete<%=list.get(i).getIdPhase() %>" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <form method="post" action="profcontroler">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" name="iddeleted" value="<%=list.get(i).getIdPhase() %>">
                                        <input type="hidden" name="command" value="2">
                      ...
                      <div id="addtask<%=list.get(i).getIdPhase() %>" class="modal fade" role="dialog">
                        <form method="get" action="taskControlr" class="form-horizontal" role="form">
                              <input type="hidden" name="idphas" value="<%=list.get(i).getIdPhase() %>">
                              <input type="hidden" name="command" value="2"> 
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">ajouter une Task pour Phase  <%=list.get(i).getNom() %> :</h4>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                    <div class="modal-body"> 
                                        <input type="hidden" name="command" value="4">
                                        <div class="form-row">
                                            ...
                                            %>
                                                <input type="text" class="form-control" id="item_name" value="<%=id %>" name="idtsk"  placeholder="Item Name" required autofocus>
