        ...
        <div class="content">
			...
			<div class="container-fluid">
				...
				<div class="row">
				                	  ...
				                	  re = (ArrayList) request.getAttribute("etd"); 
										...
										%>
											<tr>
												...
												<td>
                                                     <a href="#edit<%=etd.getIdEtudiant() %>" data-toggle="modal" >
                            <button type='button'  class="btn btn-info"><i class="fa fa-exclamation"></i></button>
                            </a>
                            <a href="#delete<%=etd.getIdEtudiant() %>" data-toggle="modal">
                            <button type='button' class="btn btn-danger"><i class="fa fa-times"></i></button>
                            </a>
                             <div id="edit<%=etd.getIdEtudiant() %>" class="modal fade" role="dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"> 
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-4">
                                               <input type="text" class="form-control" id="item_name"  name="nometd" value="<%=etd.getNom() %>" placeholder="Item Name" required autofocus>
                                             </div>
                                             </div>
                                             <div class="form-row">
                                             <label class="control-label col-sm-2" for="item_name">Prenom Etudiant:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="item_name" name="prenometd" value="<%=etd.getPrenom() %>"  required autofocus>
                                             </div>
                                             
                                              <label class="control-label col-sm-2" for="item_name">Cne:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="item_name" name="cne"  value="<%=etd.getCne() %>" required autofocus>
                                             </div>
                                             </div>
                                             <div class="form-row">
                                             <label class="control-label col-sm-2" for="item_name">Branch:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="item_name" name="brnch" value="<%=etd.getBranch() %>"  required autofocus>
                                             </div>
                                             </div>
                                    </div>
                    ...
                    <div id="delete<%=etd.getIdEtudiant()%>" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <form method="post" action="controlerEtudint">
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" name="iddeleted" value="<%=etd.getIdEtudiant()%>">
                                        <input type="hidden" name="command" value="2">
                                        <div class="alert alert-danger">Are you Sure you want Delete <strong>
                                                <%=etd.getNom() %> <%=etd.getPrenom() %> ?</strong> </div>
                                        <div class="modal-footer">
